...
export default async function handler(req, res) {
  ...
  try {
    ...
    const system = body.system || 'Você é um roteirista profissional, diretor de pré-produção e consultor de audiovisual. Crie projetos do zero com autoria do usuário, sem herdar personagens, cenas, mundos ou estilos de projetos anteriores. Presets só podem ser usados quando o usuário pedir explicitamente.';
    ...
    res.setHeader('Content-Type', 'application/json');
    return res.end(JSON.stringify({
      error: error.message || 'Erro interno no backend Client'
    }));
  }
}
